    ...
    <x-xtable>
        <x-slot name="content"> 
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 ">                            
                <tr>
                    {{-- <th scope="col" class="py-3 px-5">Code</th> --}}
                    <th scope="col" class="py-3 px-6">
                        <div wire:click="sortBy('code')"  class="flex items-center">
                            Code
                    ...
                    <th scope="col" class="py-3 px-6">Tradename</th>
            ...
            <tbody>
                @foreach ($products as $product)
                    <tr class="bg-white border-b">
                        <td class="py-4 px-5">{{ $product->code }}</td>
                        <td class="py-4 px-6 font-bold bg-gray-50">{{ $product->name }}</td>
                        <td class="py-4 px-6">{{ $product->tradename }}</td>
                        ...
                        <td class="py-3 px-6">
                            <div class="flex flex-wrap content-center">
                                ...
                                <a href="{{ route('product.show', $product) }}" class="mx-1">
                                    <img src="{{url('/ico/outline/eye.svg')}}"/>
                                </a>
                                <button type="button" class="btnDelete" id="" value="{{ $product->id }}">
